...
/**
 * A base class to wrap communication with the Google Play Services PlusClient. - Generated by Android Studio
 */
public abstract class PlusBaseActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlusClient =
                new PlusClient.Builder(this, this, this).setScopes(Scopes.PLUS_LOGIN, Scopes.PLUS_ME).build();
        Log.d("mylog","created");
    }
